...
class Train:
    ...
    def __init__(self,root):
        ...
        # backgorund image 
        bg1=Image.open(r"Images\concept.jpg")
        bg1=bg1.resize((1366,660))
        self.photobg1=ImageTk.PhotoImage(bg1)

        # set image as lable
        bg_img = Label(self.root,image=self.photobg1)
        bg_img.place(x=0,y=100,width=1366,height=660)


        #title section
        title_lb1 = Label(bg_img,text="Welcome to Training Pannel",font=("verdana",30,"bold"),bg="black",fg="yellow")
        title_lb1.place(x=0,y=0,width=1366,height=50)

        # Create buttons below the section 
        # ------------------------------------------------------------------------------------------------------------------- 
        # Training button 1
        std_img_btn=Image.open(r"Images\images (11).jpeg")
        ...
        std_b1.place(x=586,y=225,width=180,height=180)
        ...
        std_b1_1.place(x=586,y=405,width=180,height=45)
