...
class Attendance:
    ...
    def __init__(self,root):
        ...
        # first header image  
        img=Image.open(r"Images\employee-attendance-tracker.png")
        ...
        #title section
        title_lb1 = Label(bg_img,text="Welcome to Attendance Pannel",font=("verdana",30,"bold"),bg="white",fg="black")
        ...
        student_roll_entry = ttk.Entry(left_frame,textvariable=self.var_name,width=15,font=("verdana",12,"bold"))
        ...
        student_name_entry = ttk.Entry(left_frame,textvariable=self.var_roll,width=15,font=("verdana",12,"bold"))
        ...
        student_attend_label = Label(left_frame,text="Attendence:",font=("verdana",12,"bold"),fg="navyblue",bg="white")
        ...
        table_frame.place(x=10,y=140,width=635,height=250)
        ...
        #create table 
        self.attendanceReport_left = ttk.Treeview(table_frame,column=("ID","Name","Roll_No","dep","Time","Date","Attend"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
        ...
        #Exprot button
        update_btn=Button(btn_frame,command=self.CleanData,text="Clean Data",width=12,font=("verdana",12,"bold"),fg="white",bg="navyblue")
        ...
        #create table 
        self.attendanceReport = ttk.Treeview(table_frame,column=("ID","Name","Roll_No","dep","Time","Date","Attend"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
    ...
    #Update button
        ...
        del_btn.grid(row=0,column=0,padx=6,pady=10,sticky=W)
    #Update button
    ...
    #Print Button
        #del_btn=Button(right_frame,command=self.print_data,text="Print",width=12,font=("verdana",12,"bold"),fg="white",bg="darkgreen")
        #del_btn.grid(row=0,column=2,padx=6,pady=10,sticky=W)
    # ===============================update function for mysql database=================
    def update_data(self):                                                              
        if self.var_id.get()=="" or self.var_roll.get()=="" or self.var_name.get()=="" or self.var_dep.get()=="" or self.var_time.get()=="" or self.var_date.get()=="" or self.var_attend.get()=="Status":
            ...
            try:
                ...
                if Update > 0:
                    ...
                    mycursor.execute("update stdattendance set std_id=%s,std_name=%s,std_roll_no=%s,std_dep=%s,std_time=%s,std_date=%s,std_attendance=%s where std_id=%s",( 
                    self.var_id.get(),
                    self.var_roll.get(),
                    self.var_name.get(),
                    self.var_dep.get(),
    ...
    # =============================Delete Attendance form my sql============================
    #def print_data(self):
      #  messagebox.showinfo("SuccessFully","Must be Requride a Data",parent=self.root)
