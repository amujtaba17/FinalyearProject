...
class Student:
    ...
    # This part is image labels setting start 
        ...
        f_lb1.place(x=0,y=0,width=1600,height=130)
         ...
         # backgorund image 
        bg1=Image.open(r"Images\sde.jpg")
        bg1=bg1.resize((1600,768),Image.Resampling.LANCZOS)
        ...
        #title section
        title_lb1 = Label(bg_img,text="Student Pannel",font=("verdana",30,"bold"),bg="black",fg="white")
        title_lb1.place(x=0,y=0,width=1600,height=45)

        # Creating Frame 
        main_frame = Frame(bg_img,bd=1,bg="black") #bd mean border 
        main_frame.place(x=5,y=55,width=1355,height=510)

        # Left Label Frame 
        left_frame = LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Student Registration",font=("verdana",12,"bold"),fg="black")
        left_frame.place(x=10,y=10,width=660,height=480)

        # Current Course 
        current_course_frame = LabelFrame(left_frame,bd=2,bg="white",relief=RIDGE,text="Course Info",font=("verdana",12,"bold"),fg="black")
        current_course_frame.place(x=10,y=5,width=635,height=150)

        #label Department
        dep_label=Label(current_course_frame,text="Department",font=("verdana",12,"bold"),bg="black",fg="white")
        ...
        dep_combo["values"]=("Select Programme","(BS)Computer Science","(MSc.)Computer Science","(MCS)Computer Science","(BS)Mathematics","(Msc.)Mathematics","(BS)Artificial Intelligence","(Mphil)Computer Science","(Mphil)Mathematics","(Ph.D)Computer Science","(Ph.D)Mathematics")
        dep_combo.current(0)
        ...
        #label Course
        cou_label=Label(current_course_frame,text="Course",font=("verdana",12,"bold"),bg="black",fg="white")
        ...
        cou_combo["values"]=("Select Subject","Programming Fundamentals","ICT","Basic Electronics","Operating System","Analysis of Algorithms","Functional Maths","Vector Analysis","Statistics & Probabilty","Trignometry")
        cou_combo.current(0)
        ...
        #label Year
        year_label=Label(current_course_frame,text="Year",font=("verdana",12,"bold"),bg="black",fg="white")
        ...
        #label Month
        year_label=Label(current_course_frame,text="Semester",font=("verdana",12,"bold"),bg="black",fg="white")
        ...
        class_Student_frame = LabelFrame(left_frame,bd=2,bg="black",relief=RIDGE,text="Student Information",font=("verdana",12,"bold"),fg="white")
        class_Student_frame.place(x=10,y=160,width=660,height=230)

        #Student id
        studentId_label = Label(class_Student_frame,text="Student ID:",font=("verdana",12,"bold"),fg="white",bg="black")
        ...
        #Student name
        student_name_label = Label(class_Student_frame,text="Name:",font=("verdana",12,"bold"),fg="white",bg="black")
        ...
        #Class Didvision
        student_div_label = Label(class_Student_frame,text="Shift",font=("verdana",12,"bold"),fg="white",bg="black")
        ...
        #Roll No
        student_roll_label = Label(class_Student_frame,text="Roll:",font=("verdana",12,"bold"),fg="white",bg="black")
        ...
        #Gender
        student_gender_label = Label(class_Student_frame,text="Gender:",font=("verdana",12,"bold"),fg="white",bg="black")
        ...
        #Date of Birth
        student_dob_label = Label(class_Student_frame,text="DOB:",font=("verdana",12,"bold"),fg="white",bg="black")
        ...
        #Email
        student_email_label = Label(class_Student_frame,text="Email:",font=("verdana",12,"bold"),fg="white",bg="black")
        ...
        #Phone Number
        student_mob_label = Label(class_Student_frame,text="Mobile:",font=("verdana",12,"bold"),fg="white",bg="black")
        ...
        #Address
        student_address_label = Label(class_Student_frame,text="Address:",font=("verdana",12,"bold"),fg="white",bg="black")
        ...
        #Teacher Name
        student_teacher_label = Label(class_Student_frame,text="Teacher's Name:",font=("verdana",12,"bold"),fg="white",bg="black")
        student_teacher_label.grid(row=4,column=2,padx=5,pady=5,sticky=W)

        student_teacher_entry = ttk.Entry(class_Student_frame,textvariable=self.var_teacher,width=15,font=("verdana",12,"bold"))
        student_teacher_entry.grid(row=4,column=3,padx=5,pady=5,sticky=W)
        ...
        #save button
        save_btn=Button(btn_frame,command=self.add_data,text="Save",width=7,font=("verdana",12,"bold"),bg="black",fg="white")
        save_btn.grid(row=0,column=0,padx=5,pady=10,sticky=W)

        #update button
        update_btn=Button(btn_frame,command=self.update_data,text="Update",width=7,font=("verdana",12,"bold"),bg="black",fg="white")
        update_btn.grid(row=0,column=1,padx=5,pady=8,sticky=W)

        #delete button
        del_btn=Button(btn_frame,command=self.delete_data,text="Delete",width=7,font=("verdana",12,"bold"),bg="black",fg="white")
        del_btn.grid(row=0,column=2,padx=5,pady=10,sticky=W)

        #reset button
        reset_btn=Button(btn_frame,command=self.reset_data,text="Reset",width=7,font=("verdana",12,"bold"),bg="black",fg="white")
        reset_btn.grid(row=0,column=3,padx=5,pady=10,sticky=W)

        #take photo button
        take_photo_btn=Button(btn_frame,command=self.generate_dataset,text="Take Pic",width=9,font=("verdana",12,"bold"),bg="black",fg="white")
        take_photo_btn.grid(row=0,column=4,padx=5,pady=10,sticky=W)

        #update photo button
        update_photo_btn=Button(btn_frame,command=self.generate_dataset,text="Update Pic",width=9,font=("verdana",12,"bold"),bg="black",fg="white")
        ...
        search_frame.place(x=10,y=5,width=670,height=80)

        #Search System
        search_label = Label(search_frame,text="Search by:",font=("verdana",12,"bold"),fg="white",bg="black")
        ...
        search_btn=Button(search_frame,command=self.search_data,text="Search",width=9,font=("verdana",12,"bold"),bg="black",fg="white")
        search_btn.grid(row=0,column=3,padx=5,pady=10,sticky=W)

        showAll_btn=Button(search_frame,command=self.fetch_data,text="Show All",width=8,font=("verdana",12,"bold"),bg="black",fg="white")
        ...
        table_frame.place(x=10,y=100,width=665,height=360)
